...
//#define MQTT_HOST            "a1enYbL9dlS.iot-as-mqtt.cn-shanghai.aliyuncs.com" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
//#define MQTT_PORT            1883    // the listening port of your MQTT server or MQTT broker
//#define MQTT_CLIENT_ID        "001|securemode=3,signmethod=hmacsha1|"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
//#define MQTT_USER            "Port1&a1enYbL9dlS" // your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
//#define MQTT_PASS            "F9A79B92DE6519131B92E2FCA758BB7569E724DA" // you MQTT login password, same as above
//#define STA_SSID "wer"    // your AP/router SSID to config your device networking
